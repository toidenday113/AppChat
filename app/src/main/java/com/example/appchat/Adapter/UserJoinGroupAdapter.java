...
public class UserJoinGroupAdapter  extends RecyclerView.Adapter<UserJoinGroupAdapter.ViewHolder>{

    private Context mContext;
    private List<User> mUser;
    private List<String> arrUserJoinGroup;

    public UserJoinGroupAdapter(Context mContext, List<User> mUser) {
    ...
    @NonNull
    @Override
    public UserJoinGroupAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.item_user_add_group, parent, false);

        return new UserJoinGroupAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final UserJoinGroupAdapter.ViewHolder holder, final int position) {
