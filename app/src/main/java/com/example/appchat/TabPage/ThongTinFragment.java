...
public class ThongTinFragment extends Fragment {
    private ImageView _ivbg, _iv_EditName;
    ...
    private void fc_EditProfile(){
       // Upload Image
        ...
        // Edit Name
        _iv_EditName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                popUpEditName();
            }
    ...
    private void AnhXa(){
        ...
        _iv_EditName = root.findViewById(R.id.iv_EditName);
    }

    private void popUpEditName(){
        String nameOld = _tvName.getText().toString();
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                final String UsernameNew = input.getText().toString();
                DatabaseReference RefEditUsername = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid());
                HashMap<String,Object> hmEditNameGroup = new HashMap<>();
                hmEditNameGroup.put("username", UsernameNew);
                RefEditUsername.updateChildren(hmEditNameGroup).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
